...
namespace KetvirtaPamoka
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            SarasuMedodai.SpausdinkSarasa(pirmasListas); // SarasuMedodai. <-- klases, kurioje aprasytas metodas, pavadinimas
                                                           // SpausdinkSarasa <-- metodo, kuris yra iki tasko nurodytoje klaseje, pavadinimas
